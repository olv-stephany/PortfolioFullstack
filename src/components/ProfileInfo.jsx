...
const ProfileInfo = () => {
  return (
    <div className=" text-white p-6 flex flex-col items-center gap-5 rounded-xl max-w-md mx-auto">
      <img
        src={imageProfile}
      ...
      <p className=" text-sm font-medium p-2 pt-1 rounded-sm text-start w-90 ml-30 leading-relaxed border-2 border-white/100  text-white">
